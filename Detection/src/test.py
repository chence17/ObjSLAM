...
def parse_test_configs():
    ...
    parser.add_argument('--save_json', action='store_true',
                        help='If true, the output data of the testing phase will be saved') # NOTE: 输出json的代码
    ...
    if configs.save_json:
        configs.frame_dir = os.path.join(configs.working_dir, 'results', configs.saved_fn, 'frames') # NOTE: 输出json的代码
        make_folder(configs.frame_dir) # NOTE: 输出json的代码
